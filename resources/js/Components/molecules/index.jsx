...
export function ProdiStatCard({ name, count, variant = "orange" }) {
    ...
    const iconColors =
        variant === "orange" ? "text-[#C4571A]" : "text-[#6B1B1B]";

    return (
        <div className="flex items-center justify-between bg-white border border-gray-200 rounded-xl px-5 py-4 hover:shadow-md transition-shadow duration-300 cursor-pointer">
