                    ...
                    <div className="flex flex-col divide-y divide-brand-cream-border/70 md:flex-row md:divide-x md:divide-y-0">
                        {items.map(({ value, label, color }) => (
                            ...
                            >
                                ...
                                <span className="mt-1.5 text-xs font-bold uppercase tracking-widest text-gray-400">
                                    {label}
                                </span>
                            </div>
                        ))}
...
function TalkCard({ item, onClick }) {
    ...
    return (
        <div className="group relative flex cursor-pointer flex-col overflow-hidden rounded-[1.75rem] border border-brand-card-border bg-white shadow-[0_18px_60px_rgba(107,27,27,0.08)] transition-all duration-500 hover:-translate-y-2 hover:border-brand-card-hover hover:shadow-[0_28px_90px_rgba(107,27,27,0.18)] focus-within:ring-4 focus-within:ring-brand-gold/60">
            <button
                type="button"
                onClick={onClick}
            ...
            />
            <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-linear-to-r from-brand-primary via-brand-gold to-brand-copper" />
            ...
            <div className="relative flex h-60 items-center justify-center overflow-hidden bg-kub-media">
                ...
                <div className="absolute inset-0 bg-linear-to-t from-kub-overlay/75 via-kub-overlay/8 to-kub-overlay/35" />
                <div
                    className="absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                    style={{
                        background:
                            "radial-gradient(circle at 25% 10%, rgba(245,166,35,.28), transparent 32%)",
                    }}
                />
...
function Lightbox({ gallery, index, onClose, showcaseLabel, dialogLabel }) {
    ...
    return (
        <dialog
            ...
            className="relative m-auto open:grid w-full max-w-6xl overflow-y-auto rounded-4xl border border-white/18 bg-brand-night p-0 shadow-[0_40px_140px_rgba(0,0,0,0.55)] md:grid-cols-[1.35fr_.85fr] md:overflow-hidden animate-kub-modal-rise backdrop-kub-lightbox"
        ...
        >
            ...
            <div className="relative flex min-h-[42vh] items-center justify-center overflow-hidden bg-kub-media md:min-h-[76vh]">
                ...
                />
                <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-brand-night/70 via-transparent to-brand-night/30" />
                <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-linear-to-t from-brand-night to-transparent" />
                        ...
                        <div className="absolute bottom-6 left-6 right-6 z-20">
                            <div className="h-1.5 overflow-hidden rounded-full bg-white/14">
                                <div
                                    ...
                                    className="h-full rounded-full bg-linear-to-r from-brand-gold to-brand-gold-light transition-all duration-500"
            ...
            <div className="relative flex min-h-0 flex-col overflow-y-auto bg-kub-detail-panel p-5 md:p-7">
                ...
                {item.companyName && (
                    <div className="mb-5 flex items-center gap-3 rounded-2xl border border-brand-cream-border bg-white/80 p-3 shadow-sm backdrop-blur">
                        ...
                        <div className="min-w-0">
                            <p className="text-[11px] font-black uppercase tracking-[0.16em] text-brand-copper">
                                Mitra Industri
                            </p>
                            <p className="truncate text-base font-black text-brand-text-dark">
                                {item.companyName}
                            </p>
                        </div>
                    </div>
                ...
                {item.desc && (
                    <p className="mt-3 text-sm leading-7 text-brand-body-muted">
                        {item.desc}
                    </p>
                )}
                ...
                {images.length > 1 && (
                    <div className="mt-5 min-h-0">
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <p className="text-xs font-bold text-brand-copper">
                                {images.length} dokumentasi
                            </p>
                        </div>
...
/* ─────────────────────────────────────────────────────────
   PAGE
───────────────────────────────────────────────────────── */
export function IndustryShowcasePage({
    gallery = [],
