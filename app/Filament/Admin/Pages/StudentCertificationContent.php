...
class StudentCertificationContent extends Page
{
    protected string $view = 'filament.admin.pages.student-certification-content';
    ...
    protected static ?string $slug = 'student-certification-content';
